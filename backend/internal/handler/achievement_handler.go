...
func (h *AchievementHandler) GetStudentAchievement(c *gin.Context) {
...
func (h *AchievementHandler) GetStudentProgress(c *gin.Context) {
	studentID := c.Param("id")
...
func (h *AchievementHandler) GetClassAchievement(c *gin.Context) {
	classID := c.Param("id")
	subjectID := c.Query("subject_id")
...
func (h *AchievementHandler) GetReportAchievementSummary(c *gin.Context) {
