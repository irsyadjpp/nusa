...
type Assessment struct {
	...
	ModulAjarID       string         `json:"modul_ajar_id" db:"modul_ajar_id"`
...
type AssessmentResponse struct {
	ID                string         `json:"id"`
	ModulAjarID       string         `json:"modul_ajar_id"`
	ModulAjarTopic    string         `json:"modul_ajar_topic"`
...
type CreateAssessmentRequest struct {
	ModulAjarID       string       `json:"modul_ajar_id" binding:"required"`
...
// Evidence represents student learning evidence
...
// Evaluation represents student performance evaluation
