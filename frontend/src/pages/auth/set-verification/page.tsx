...
export default function Page() {
  ...
  const handleSubmit = (event: FormEvent) => {
    ...
    // Verification code submit API integration - not yet implemented in backend
    // This will be implemented once backend has verification endpoints
    console.warn("Verification code submit endpoint not yet implemented in backend");
    navigate("/");
  };
            ...
            <Box className="flex flex-col gap-10">
              ...
              <Box className="flex flex-col">
                ...
                <Typography variant="body1" className="text-text-secondary">
                  ...
                  <Link to="/get-verification" className="link-primary link-underline-hover">
                    resend
                  </Link>
                  .
                </Typography>
