...
export default function Page() {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    // Password reset API integration - not yet implemented in backend
    // This will be implemented once backend has password reset request endpoint
    console.warn("Password reset request endpoint not yet implemented in backend");
            ...
            <Box className="flex flex-col gap-10">
              ...
              <Box className="flex flex-col">
                ...
                <Typography variant="body1" className="text-text-secondary">
                  ...
                  <Link to="/sign-in" className="link-primary link-underline-hover">
                    sign in
                  </Link>
                  .
                </Typography>
