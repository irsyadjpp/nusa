...
export default function Page() {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    // Verification code send API integration - not yet implemented in backend
    // This will be implemented once backend has verification endpoints
    console.warn("Verification send endpoint not yet implemented in backend");
    navigate("/set-verification");
  };
            ...
            <Box className="flex flex-col gap-10">
              ...
              <Box className="flex flex-col">
                ...
                <Typography variant="body1" className="text-text-secondary">
                  ...
                  <Link to="/set-verification" className="link-primary link-underline-hover">
                    submit
                  </Link>{" "}
                  here.
                </Typography>
