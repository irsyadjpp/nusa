...
const StudentDashboard = () => {
  ...
  const stats = [
    { title: 'My Classes', value: classes?.data?.length || '6', icon: <SchoolIcon />, color: 'primary' },
    { title: 'Pending Assignments', value: '4', icon: <AssignmentIcon />, color: 'warning' },
    { title: 'Upcoming Classes', value: '3', icon: <EventIcon />, color: 'info' },
    { title: 'Overall Progress', value: '78%', icon: <TrendingUpIcon />, color: 'success' },
  ];
  ...
  const upcomingSchedule = todaySchedule.map((schedule: any) => ({
    ...
    { subject: 'Science', class: '10-A', time: '10:00-11:30', room: 'Room 205' },
    { subject: 'Physics', class: '10-A', time: '13:00-14:30', room: 'Lab 301' },
  ];

  const recentActivities = [
    { title: 'Submitted: Mathematics Chapter 5 Quiz', time: '2 hours ago', type: 'submission' },
    { title: 'New Assignment: Science Lab Report', time: '5 hours ago', type: 'assignment' },
    { title: 'Attendance Marked: Present', time: '1 day ago', type: 'attendance' },
    { title: 'Grade Posted: Physics Quiz', time: '2 days ago', type: 'grade' },
  ];
    ...
    <Container maxWidth="xl">
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Welcome back! Here's an overview of your learning activities.
        </Typography>
      </Box>
