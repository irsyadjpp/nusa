...
export default function LeftMenu() {
  ...
  const filteredMenuItems = useMemo(() => filterMenuByRole(leftMenuItems), [filterMenuByRole, leftMenuItems]);
  const filteredBottomMenuItems = useMemo(() => filterMenuByRole(leftMenuBottomItems), [filterMenuByRole, leftMenuBottomItems]);
