...
export default function Notifications() {
  const [notificationData, setNotificationData] = useState<NotificationData[]>([
    {
      id: "100",
      labelBold: "Budi Santoso",
      labelRegular: "menambahkan TP baru dengan lampiran.",
      type: "user",
      time: "2 menit yang lalu",
      href: "/pages/tp/detail",
      avatarImage: "/images/avatars/avatar-1.jpg",
      temporaryUnread: true,
      markedUnread: false,
      chips: [{ label: "tp-matematika-1.pdf", image: "/images/products/product-1.jpg", id: "1001" }],
    },
    {
      id: "101",
      labelBold: "Siti Rahayu",
      labelRegular: "menambahkan isu asesmen.",
      type: "user",
      ...
      markedUnread: false,
      chips: [
        { label: "Asesmen", id: "1011" },
        { label: "Matematika", id: "1012" },
      ],
    },
    {
      id: "102",
      labelBold: "Ahmad Wijaya",
      labelRegular: "meminta akses editor.",
      type: "user",
      ...
      markedUnread: false,
      actions: [
        { type: "positive", id: "1021", label: "Setujui" },
        { type: "negative", id: "1022", label: "Tolak" },
      ],
    },
    {
      id: "103",
      labelBold: "Dewi Lestari",
      labelRegular: "menambahkan postingan.",
      type: "user",
    ...
    {
      id: "104",
      labelBold: "Versi Baru!",
      labelRegular: "NUSA Platform v2 dengan fitur Kurikulum Merdeka.",
      type: "system",
    ...
    },
    {
      id: "105",
      labelBold: "Tips:",
      labelRegular: "Ada masalah? Buat isu untuk bantuan.",
      type: "system",
      time: "4 jam yang lalu",
    ...
    {
      id: "106",
      labelBold: "Butuh bantuan?",
      labelRegular: "Gunakan Basis Pengetahuan untuk mendapatkan bantuan.",
      type: "system",
